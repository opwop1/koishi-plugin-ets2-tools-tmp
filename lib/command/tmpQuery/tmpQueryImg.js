    ...
    if (cfg.commands?.tmpQueryGameTime) {
        try {
            ...
            if (steamApiKey) {
                ...
                const url = `https://evmapi.114512.xyz/proxy/steam/IPlayerService/GetOwnedGames/v1?key=${steamApiKey}&steamid=${steamId}&appids_filter[0]=227300&appids_filter[1]=270880&include_played_free_games=1`;
